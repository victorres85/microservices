module "aws-prod" {
  ...
  AWS_ACCESS_KEY = "AKIAVGRJ4JAM3IFJOM6S"
  AWS_SECRET_KEY = "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"
  BUCKET_NAME = "felix-quiz-1000heads"
  AWS_REGION = "eu-west-2"
  DB_HOST = "localhost"
  DB_NAME = "felixdb"
  DB_USER = "felixuser"
  DB_PASS = "MvMw2i2Dac5S0mT5YkEhZxqq6"
  DB_PORT=5432
  DJANGO_ENV = "prod"
  DJANGO_SECRET_KEY = "aQo7+m02bf6@eeobx6_9c7Qo798p5mv5s*wc4tQ*3y@4++m02bf6or%m^ap1b"
