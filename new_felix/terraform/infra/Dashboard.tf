  ...
  "widgets": [
    {
      ...
      "properties": {
        "metrics": [
          [ "AWS/ApplicationELB", "TargetResponseTime", "LoadBalancer", "${aws_lb.alb-purina.arn}", "TargetGroup", "${aws_lb_target_group.target_lb.arn}" ]
        ],
        "period": 300,
        "stat": "Average",
        "region": "eu-west-2",
  ...
  "widgets": [
    {
      ...
      "properties": {
        "metrics": [
          [ "AWS/ApplicationELB", "UnHealthyHostCount", "LoadBalancer", "${aws_lb.alb-purina.arn}", "TargetGroup", "${aws_lb_target_group.target_lb.arn}" ]
        ],
        "period": 300,
        "stat": "SampleCount",
        "region": "eu-west-2",
